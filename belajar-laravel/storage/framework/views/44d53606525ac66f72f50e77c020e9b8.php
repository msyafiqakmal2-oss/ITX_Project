    ...
    <div class="sm:mx-auto sm:w-full sm:max-w-4xl bg-white rounded-3xl shadow-xl border border-gray-100 overflow-hidden grid grid-cols-1 md:grid-cols-12">
        ...
        <div class="md:col-span-5 bg-gradient-to-br from-brand-blue via-brand-navy to-blue-900 p-8 text-white flex flex-col justify-between relative overflow-hidden">
            ...
            <div class="relative z-10 mt-8 pt-6 border-t border-white/10 text-[11px] text-blue-200">
                Sudah punya akun? <a href="<?php echo e(route('login')); ?>" class="text-brand-yellow font-bold hover:underline">Masuk Sekarang</a>
            </div>
        </div>
            ...
            <form method="POST" action="<?php echo e(route('register')); ?>" class="space-y-4">
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 gap-3">
                    <div>
                        ...
                        <input type="text" name="name" value="<?php echo e(old('name')); ?>" required class="w-full px-3.5 py-2.5 rounded-xl border border-gray-300 focus:ring-2 focus:ring-brand-blue text-xs outline-none transition" placeholder="Ahmad Fauzi">
                    </div>
                    <div>
                        <label class="block text-xs font-bold text-gray-700 mb-1">NIM / NIMKO</label>
                        <input type="text" name="nim" value="<?php echo e(old('nim')); ?>" required class="w-full px-3.5 py-2.5 rounded-xl border border-gray-300 focus:ring-2 focus:ring-brand-blue text-xs outline-none transition" placeholder="402026...">
                    </div>
                </div>
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 gap-3">
                    ...
                    <div>
                        ...
                        <input type="text" name="prodi" value="<?php echo e(old('prodi')); ?>" required class="w-full px-3.5 py-2.5 rounded-xl border border-gray-300 focus:ring-2 focus:ring-brand-blue text-xs outline-none transition" placeholder="Contoh: Teknik Informatika">
                    </div>
                </div>
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 gap-3">
                    <div>
                        ...
                        <input type="email" name="email" value="<?php echo e(old('email')); ?>" required class="w-full px-3.5 py-2.5 rounded-xl border border-gray-300 focus:ring-2 focus:ring-brand-blue text-xs outline-none transition" placeholder="mahasiswa@unida.gontor.ac.id">
                    </div>
                    <div>
                        <label class="block text-xs font-bold text-gray-700 mb-1">Nomor WhatsApp / HP</label>
                        <input type="text" name="no_hp" value="<?php echo e(old('no_hp')); ?>" required class="w-full px-3.5 py-2.5 rounded-xl border border-gray-300 focus:ring-2 focus:ring-brand-blue text-xs outline-none transition" placeholder="08123456789">
                    </div>
                </div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/syafiqakmal/Downloads/belajar-laravel/resources/views/auth/register.blade.php ENDPATH**/ ?>