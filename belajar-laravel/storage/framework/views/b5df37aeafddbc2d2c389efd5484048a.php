    ...
    <?php $__empty_1 = true; $__currentLoopData = $barangs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
        <div class="bg-white rounded-xl border border-gray-200 shadow-sm hover:shadow-lg transition flex flex-col justify-between overflow-hidden relative group">
            ...
            <div class="absolute top-2 right-2 z-10 flex flex-col space-y-1 opacity-0 group-hover:opacity-100 transition">
                <button onclick="editBarang(<?php echo e(json_encode($item)); ?>)" class="w-7 h-7 bg-white/90 hover:bg-brand-blue hover:text-white text-gray-600 rounded-full flex items-center justify-center shadow text-xs transition" title="Edit Master Data">
            ...
            <div>
                ...
                <div class="h-36 bg-gray-50 flex items-center justify-center p-2 relative border-b border-gray-100 overflow-hidden">
                    <?php if($item->gambar): ?>
                        <img src="<?php echo e(asset('storage/' . $item->gambar)); ?>" alt="<?php echo e($item->nama_barang); ?>" class="w-full h-full object-cover">
                    <?php else: ?>
            ...
            <div class="p-3 pt-0">
                <button onclick="addToCart(<?php echo e(json_encode($item)); ?>)" class="w-full bg-brand-blue hover:bg-brand-navy text-white font-bold py-2 px-2 rounded-lg text-xs flex items-center justify-center space-x-1.5 shadow-sm transition active:scale-95">
