<?php $__env->startSection('title', 'Kasir & Pembayaran - UEC MART'); ?>
...
<div class="max-w-4xl mx-auto py-6 px-4">
    ...
    <div class="flex items-center justify-between mb-6">
        ...
        <a href="<?php echo e(route('barang.index')); ?>" class="text-xs font-bold text-brand-blue hover:text-brand-navy flex items-center gap-1 bg-blue-50 px-3 py-2 rounded-lg border border-blue-100">
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/syafiqakmal/Downloads/belajar-laravel/resources/views/transaksi/checkout.blade.php ENDPATH**/ ?>